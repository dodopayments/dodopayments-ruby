    ...
    class SubscriptionFailedWebhookEvent < Dodopayments::Internal::Type::BaseModel
      ...
      sig do
        params(
          ...
          data: Dodopayments::SubscriptionFailedWebhookEvent::Data::OrHash,
          timestamp: Time,
          type: Dodopayments::SubscriptionFailedWebhookEvent::Type::OrSymbol
      ...
      class Data < Dodopayments::Models::Subscription
        ...
        sig do
          returns(
            T.nilable(
              Dodopayments::SubscriptionFailedWebhookEvent::Data::PayloadType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            payload_type:
              Dodopayments::SubscriptionFailedWebhookEvent::Data::PayloadType::OrSymbol
          ).void
        end
        ...
        module PayloadType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Dodopayments::SubscriptionFailedWebhookEvent::Data::PayloadType
              )
            end
