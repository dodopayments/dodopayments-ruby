...
module Dodopayments
  module Models
    class CreditOverageResetWebhookEvent < Dodopayments::Internal::Type::BaseModel
      ...
      sig do
        returns(
          Dodopayments::CreditOverageResetWebhookEvent::Type::TaggedSymbol
        )
      end
      attr_accessor :type
      ...
      sig do
        params(
          ...
          data: Dodopayments::CreditEntitlements::CreditLedgerEntry::OrHash,
          timestamp: Time,
          type: Dodopayments::CreditOverageResetWebhookEvent::Type::OrSymbol
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Dodopayments::CreditOverageResetWebhookEvent::Type)
          end
