...
module Dodopayments
  module Models
    class EntitlementGrantFailedWebhookEvent < Dodopayments::Internal::Type::BaseModel
      ...
      sig { returns(Dodopayments::EntitlementGrantFailedWebhookEvent::Data) }
      attr_reader :data

      sig do
        params(
          data: Dodopayments::EntitlementGrantFailedWebhookEvent::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            business_id: String,
            data: Dodopayments::EntitlementGrantFailedWebhookEvent::Data,
            timestamp: Time,
            type:
              Dodopayments::EntitlementGrantFailedWebhookEvent::Type::TaggedSymbol
          }
      ...
      class Data < Dodopayments::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Dodopayments::EntitlementGrantFailedWebhookEvent::Data,
              Dodopayments::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            Dodopayments::EntitlementGrantFailedWebhookEvent::Data::Status::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            license_key:
              T.nilable(
                Dodopayments::EntitlementGrantFailedWebhookEvent::Data::LicenseKey::OrHash
              )
          ).void
        end
        ...
        sig do
          params(
            ...
            external_id: String,
            status:
              Dodopayments::EntitlementGrantFailedWebhookEvent::Data::Status::OrSymbol,
            updated_at: Time,
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Dodopayments::EntitlementGrantFailedWebhookEvent::Data::Status
              )
            end
