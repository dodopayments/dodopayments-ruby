...
module Dodopayments
  module Models
    class EntitlementGrantRevokedWebhookEvent < Dodopayments::Internal::Type::BaseModel
      ...
      sig { returns(Dodopayments::EntitlementGrantRevokedWebhookEvent::Data) }
      attr_reader :data

      sig do
        params(
          data: Dodopayments::EntitlementGrantRevokedWebhookEvent::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            business_id: String,
            data: Dodopayments::EntitlementGrantRevokedWebhookEvent::Data,
            timestamp: Time,
            type:
              Dodopayments::EntitlementGrantRevokedWebhookEvent::Type::TaggedSymbol
          }
      ...
      class Data < Dodopayments::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Dodopayments::EntitlementGrantRevokedWebhookEvent::Data,
              Dodopayments::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            Dodopayments::EntitlementGrantRevokedWebhookEvent::Data::Status::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            license_key:
              T.nilable(
                Dodopayments::EntitlementGrantRevokedWebhookEvent::Data::LicenseKey::OrHash
              )
          ).void
        end
        ...
        sig do
          params(
            ...
            external_id: String,
            status:
              Dodopayments::EntitlementGrantRevokedWebhookEvent::Data::Status::OrSymbol,
            updated_at: Time,
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Dodopayments::EntitlementGrantRevokedWebhookEvent::Data::Status
              )
            end
