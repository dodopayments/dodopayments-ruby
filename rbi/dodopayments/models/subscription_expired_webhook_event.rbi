    ...
    class SubscriptionExpiredWebhookEvent < Dodopayments::Internal::Type::BaseModel
      ...
      sig do
        params(
          ...
          data: Dodopayments::SubscriptionExpiredWebhookEvent::Data::OrHash,
          timestamp: Time,
          type: Dodopayments::SubscriptionExpiredWebhookEvent::Type::OrSymbol
      ...
      class Data < Dodopayments::Models::Subscription
        ...
        sig do
          returns(
            T.nilable(
              Dodopayments::SubscriptionExpiredWebhookEvent::Data::PayloadType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            payload_type:
              Dodopayments::SubscriptionExpiredWebhookEvent::Data::PayloadType::OrSymbol
          ).void
        end
        ...
        module PayloadType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Dodopayments::SubscriptionExpiredWebhookEvent::Data::PayloadType
              )
            end
