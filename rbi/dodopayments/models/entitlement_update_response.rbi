  ...
  module Models
    class EntitlementUpdateResponse < Dodopayments::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Dodopayments::Models::EntitlementUpdateResponse,
      ...
      sig do
        returns(
          Dodopayments::Models::EntitlementUpdateResponse::IntegrationConfig::Variants
        )
      end
      ...
      sig do
        returns(
          Dodopayments::Models::EntitlementUpdateResponse::IntegrationType::TaggedSymbol
        )
      end
      ...
      sig do
        params(
          ...
          integration_config:
            T.any(
              Dodopayments::Models::EntitlementUpdateResponse::IntegrationConfig::GitHubConfig::OrHash,
              Dodopayments::Models::EntitlementUpdateResponse::IntegrationConfig::DiscordConfig::OrHash,
              Dodopayments::Models::EntitlementUpdateResponse::IntegrationConfig::TelegramConfig::OrHash,
              Dodopayments::Models::EntitlementUpdateResponse::IntegrationConfig::FigmaConfig::OrHash,
              Dodopayments::Models::EntitlementUpdateResponse::IntegrationConfig::FramerConfig::OrHash,
              Dodopayments::Models::EntitlementUpdateResponse::IntegrationConfig::NotionConfig::OrHash,
              Dodopayments::Models::EntitlementUpdateResponse::IntegrationConfig::DigitalFilesConfig::OrHash,
              Dodopayments::Models::EntitlementUpdateResponse::IntegrationConfig::LicenseKeyConfig::OrHash
            ),
          integration_type:
            Dodopayments::Models::EntitlementUpdateResponse::IntegrationType::OrSymbol,
          is_active: T::Boolean,
          name: String,
          updated_at: Time,
      ...
      module IntegrationConfig
        ...
        Variants =
          T.type_alias do
            T.any(
              Dodopayments::Models::EntitlementUpdateResponse::IntegrationConfig::GitHubConfig,
              Dodopayments::Models::EntitlementUpdateResponse::IntegrationConfig::DiscordConfig,
              Dodopayments::Models::EntitlementUpdateResponse::IntegrationConfig::TelegramConfig,
              Dodopayments::Models::EntitlementUpdateResponse::IntegrationConfig::FigmaConfig,
              Dodopayments::Models::EntitlementUpdateResponse::IntegrationConfig::FramerConfig,
              Dodopayments::Models::EntitlementUpdateResponse::IntegrationConfig::NotionConfig,
              Dodopayments::Models::EntitlementUpdateResponse::IntegrationConfig::DigitalFilesConfig,
              Dodopayments::Models::EntitlementUpdateResponse::IntegrationConfig::LicenseKeyConfig
            )
          end
        ...
        class DigitalFilesConfig < Dodopayments::Internal::Type::BaseModel
          ...
          sig do
            params(
              digital_files:
                Dodopayments::Models::EntitlementUpdateResponse::IntegrationConfig::DigitalFilesConfig::DigitalFiles::OrHash
            ).void
          end
          ...
          class DigitalFiles < Dodopayments::Internal::Type::BaseModel
            ...
            sig do
              params(
                files:
                  T::Array[
                    Dodopayments::Models::EntitlementUpdateResponse::IntegrationConfig::DigitalFilesConfig::DigitalFiles::File::OrHash
                  ],
      ...
      module IntegrationType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Dodopayments::Models::EntitlementUpdateResponse::IntegrationType
            )
          end
