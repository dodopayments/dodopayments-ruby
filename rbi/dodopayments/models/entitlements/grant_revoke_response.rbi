    ...
    module Entitlements
      class GrantRevokeResponse < Dodopayments::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Dodopayments::Models::Entitlements::GrantRevokeResponse,
        ...
        sig do
          returns(
            Dodopayments::Models::Entitlements::GrantRevokeResponse::Status::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            license_key:
              T.nilable(
                Dodopayments::Models::Entitlements::GrantRevokeResponse::LicenseKey::OrHash
              )
          ).void
        end
        ...
        sig do
          params(
            ...
            external_id: String,
            status:
              Dodopayments::Models::Entitlements::GrantRevokeResponse::Status::OrSymbol,
            updated_at: Time,
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Dodopayments::Models::Entitlements::GrantRevokeResponse::Status
              )
            end
