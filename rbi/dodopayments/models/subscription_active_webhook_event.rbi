    ...
    class SubscriptionActiveWebhookEvent < Dodopayments::Internal::Type::BaseModel
      ...
      class Data < Dodopayments::Models::Subscription
        ...
        sig do
          returns(
            T.nilable(
              Dodopayments::SubscriptionActiveWebhookEvent::Data::PayloadType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            payload_type:
              Dodopayments::SubscriptionActiveWebhookEvent::Data::PayloadType::OrSymbol
          ).void
        end
        ...
        module PayloadType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Dodopayments::SubscriptionActiveWebhookEvent::Data::PayloadType
              )
            end
