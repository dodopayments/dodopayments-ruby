...
module Dodopayments
  module Models
    class EntitlementGrantDeliveredWebhookEvent < Dodopayments::Internal::Type::BaseModel
      ...
      sig { returns(Dodopayments::EntitlementGrantDeliveredWebhookEvent::Data) }
      attr_reader :data

      sig do
        params(
          data:
            Dodopayments::EntitlementGrantDeliveredWebhookEvent::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            business_id: String,
            data: Dodopayments::EntitlementGrantDeliveredWebhookEvent::Data,
            timestamp: Time,
            type:
              Dodopayments::EntitlementGrantDeliveredWebhookEvent::Type::TaggedSymbol
          }
      ...
      class Data < Dodopayments::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Dodopayments::EntitlementGrantDeliveredWebhookEvent::Data,
              Dodopayments::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            Dodopayments::EntitlementGrantDeliveredWebhookEvent::Data::Status::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            license_key:
              T.nilable(
                Dodopayments::EntitlementGrantDeliveredWebhookEvent::Data::LicenseKey::OrHash
              )
          ).void
        end
        ...
        sig do
          params(
            ...
            external_id: String,
            status:
              Dodopayments::EntitlementGrantDeliveredWebhookEvent::Data::Status::OrSymbol,
            updated_at: Time,
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Dodopayments::EntitlementGrantDeliveredWebhookEvent::Data::Status
              )
            end
