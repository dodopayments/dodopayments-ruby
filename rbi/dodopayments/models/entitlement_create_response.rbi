  ...
  module Models
    class EntitlementCreateResponse < Dodopayments::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Dodopayments::Models::EntitlementCreateResponse,
      ...
      sig do
        returns(
          Dodopayments::Models::EntitlementCreateResponse::IntegrationConfig::Variants
        )
      end
      ...
      sig do
        returns(
          Dodopayments::Models::EntitlementCreateResponse::IntegrationType::TaggedSymbol
        )
      end
      ...
      sig do
        params(
          ...
          integration_config:
            T.any(
              Dodopayments::Models::EntitlementCreateResponse::IntegrationConfig::GitHubConfig::OrHash,
              Dodopayments::Models::EntitlementCreateResponse::IntegrationConfig::DiscordConfig::OrHash,
              Dodopayments::Models::EntitlementCreateResponse::IntegrationConfig::TelegramConfig::OrHash,
              Dodopayments::Models::EntitlementCreateResponse::IntegrationConfig::FigmaConfig::OrHash,
              Dodopayments::Models::EntitlementCreateResponse::IntegrationConfig::FramerConfig::OrHash,
              Dodopayments::Models::EntitlementCreateResponse::IntegrationConfig::NotionConfig::OrHash,
              Dodopayments::Models::EntitlementCreateResponse::IntegrationConfig::DigitalFilesConfig::OrHash,
              Dodopayments::Models::EntitlementCreateResponse::IntegrationConfig::LicenseKeyConfig::OrHash
            ),
          integration_type:
            Dodopayments::Models::EntitlementCreateResponse::IntegrationType::OrSymbol,
          is_active: T::Boolean,
          name: String,
          updated_at: Time,
      ...
      module IntegrationConfig
        ...
        Variants =
          T.type_alias do
            T.any(
              Dodopayments::Models::EntitlementCreateResponse::IntegrationConfig::GitHubConfig,
              Dodopayments::Models::EntitlementCreateResponse::IntegrationConfig::DiscordConfig,
              Dodopayments::Models::EntitlementCreateResponse::IntegrationConfig::TelegramConfig,
              Dodopayments::Models::EntitlementCreateResponse::IntegrationConfig::FigmaConfig,
              Dodopayments::Models::EntitlementCreateResponse::IntegrationConfig::FramerConfig,
              Dodopayments::Models::EntitlementCreateResponse::IntegrationConfig::NotionConfig,
              Dodopayments::Models::EntitlementCreateResponse::IntegrationConfig::DigitalFilesConfig,
              Dodopayments::Models::EntitlementCreateResponse::IntegrationConfig::LicenseKeyConfig
            )
          end
        ...
        class DigitalFilesConfig < Dodopayments::Internal::Type::BaseModel
          ...
          sig do
            params(
              digital_files:
                Dodopayments::Models::EntitlementCreateResponse::IntegrationConfig::DigitalFilesConfig::DigitalFiles::OrHash
            ).void
          end
          ...
          class DigitalFiles < Dodopayments::Internal::Type::BaseModel
            ...
            sig do
              params(
                files:
                  T::Array[
                    Dodopayments::Models::EntitlementCreateResponse::IntegrationConfig::DigitalFilesConfig::DigitalFiles::File::OrHash
                  ],
      ...
      module IntegrationType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Dodopayments::Models::EntitlementCreateResponse::IntegrationType
            )
          end
