...
module Dodopayments
  module Models
    class SubscriptionPausedWebhookEvent < Dodopayments::Internal::Type::BaseModel
      ...
      sig { returns(Dodopayments::SubscriptionPausedWebhookEvent::Data) }
      attr_reader :data

      sig do
        params(
          data: Dodopayments::SubscriptionPausedWebhookEvent::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      class Data < Dodopayments::Models::Subscription
        OrHash =
          T.type_alias do
            T.any(
              Dodopayments::SubscriptionPausedWebhookEvent::Data,
              Dodopayments::Internal::AnyHash
            )
          end
