...
module Dodopayments
  ...
  class PooledNetRequester
    ...
    class << self
      ...
      # @api private
      sig do
        params(request: Dodopayments::PooledNetRequester::RequestShape, blk: T.proc.params(arg0: String).void)
    ...
    # @api private
    sig do
      params(request: Dodopayments::PooledNetRequester::RequestShape)
