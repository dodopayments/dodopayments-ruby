...
module Dodopayments
  module Type
    ...
    module Union
      ...
      sig { returns(T::Array[[T.nilable(Symbol), T.proc.returns(Dodopayments::Type::Converter::Input)]]) }
      ...
      # @api private
      sig do
        override.params(value: T.anything, state: Dodopayments::Type::Converter::State).returns(T.anything)
      end
