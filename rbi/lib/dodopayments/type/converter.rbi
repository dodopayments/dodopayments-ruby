...
module Dodopayments
  module Type
    # @api private
    module Converter
      Input = T.type_alias { T.any(Dodopayments::Type::Converter, T::Class[T.anything]) }
      ...
      # @api private
      sig do
        overridable.params(value: T.anything, state: Dodopayments::Type::Converter::State).returns(T.anything)
      end
      ...
      class << self
            ...
            spec: T.any(
              {
                ...
                enum: T.nilable(T.proc.returns(Dodopayments::Type::Converter::Input)),
                union: T.nilable(T.proc.returns(Dodopayments::Type::Converter::Input))
              },
        ...
        sig do
          params(
            target: Dodopayments::Type::Converter::Input,
            value: T.anything,
        ...
        # @api private
        sig { params(target: Dodopayments::Type::Converter::Input, value: T.anything).returns(T.anything) }
