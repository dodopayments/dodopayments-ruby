...
module Dodopayments
  module Internal
    ...
    module Util
      ...
      #   structure when using `Dodopayments::Internal::Util.deep_merge`.
      #
      ...
      class << self
        ...
        sig do
          params(
            data: T.any(Dodopayments::Internal::Util::AnyHash, T::Array[T.anything], T.anything),
      ...
      class << self
        ...
        sig { params(lines: T::Enumerable[String]).returns(Dodopayments::Internal::Util::ServerSentEvent) }
