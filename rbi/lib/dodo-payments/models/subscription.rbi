...
module DodoPayments
  module Models
    class Subscription < DodoPayments::BaseModel
      ...
      sig { returns(DodoPayments::Models::Subscription::Customer) }
      def customer
      end

      sig do
        params(_: DodoPayments::Models::Subscription::Customer)
          .returns(DodoPayments::Models::Subscription::Customer)
      end
      def customer=(_)
      end
