...
module DodoPayments
  ...
  module Converter
    ...
    class << self
      ...
      def type_info(spec)
        ...
        in Proc
          spec
        in DodoPayments::Converter | Class | Symbol
          -> { spec }
        in true | false
  ...
  # @example
  # ```ruby
  # # `country_code` is a `DodoPayments::Models::Misc::CountryCode`
  # case country_code
  # when DodoPayments::Models::Misc::CountryCode::AF
  #   # ...
  # when DodoPayments::Models::Misc::CountryCode::AX
  #   # ...
  # when DodoPayments::Models::Misc::CountryCode::AL
  #   # ...
  # else
  #   puts(country_code)
  # end
  ...
  class Enum
    ...
    # @return [Boolean]
    def self.==(other)
      other.is_a?(Class) && other <= DodoPayments::Enum && other.values.to_set == values.to_set
    end
  ...
  class Union
    ...
    class << self
      ...
      private def variant(key, spec = nil)
        variant_info =
          ...
          in Proc | DodoPayments::Converter | Class | Hash
    ...
    # @return [Boolean]
    def self.==(other)
      other.is_a?(Class) && other <= DodoPayments::Union && other.derefed_variants == derefed_variants
    end
  ...
  # @example
  # ```ruby
  # # `payment` is a `DodoPayments::Models::Payment`
  # payment => {
  ...
  class BaseModel
    ...
    class << self
      ...
      private def add_field(name_sym, required:, type_info:, spec:)
        type_fn, info =
          case type_info
          in Proc | Class | DodoPayments::Converter
