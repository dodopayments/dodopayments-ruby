...
module DodoPayments
  module Models
    class SubscriptionListParams < DodoPayments::BaseModel
      ...
      optional :status, enum: -> { DodoPayments::Models::SubscriptionListParams::Status }, nil?: true
      ...
      #   # @param status [Symbol, DodoPayments::Models::SubscriptionListParams::Status, nil]
