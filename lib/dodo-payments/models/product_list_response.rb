...
module DodoPayments
  module Models
    class ProductListResponse < DodoPayments::BaseModel
      ...
      #
      #   @return [DodoPayments::Models::ProductListResponse::PriceDetail::OneTimePrice, DodoPayments::Models::ProductListResponse::PriceDetail::RecurringPrice, nil]
      optional :price_detail, union: -> { DodoPayments::Models::ProductListResponse::PriceDetail }, nil?: true
      ...
      #   # @param price_detail [DodoPayments::Models::ProductListResponse::PriceDetail::OneTimePrice, DodoPayments::Models::ProductListResponse::PriceDetail::RecurringPrice, nil]
      ...
      class PriceDetail < DodoPayments::Union
        ...
        variant :one_time_price, -> { DodoPayments::Models::ProductListResponse::PriceDetail::OneTimePrice }

        variant :recurring_price, -> { DodoPayments::Models::ProductListResponse::PriceDetail::RecurringPrice }

        class OneTimePrice < DodoPayments::BaseModel
          # @!attribute currency
          #
          #   @return [Symbol, DodoPayments::Models::ProductListResponse::PriceDetail::OneTimePrice::Currency]
          required :currency,
                   enum: -> { DodoPayments::Models::ProductListResponse::PriceDetail::OneTimePrice::Currency }
          ...
          # @!parse
          #   # @param currency [Symbol, DodoPayments::Models::ProductListResponse::PriceDetail::OneTimePrice::Currency]
        ...
        class RecurringPrice < DodoPayments::BaseModel
          # @!attribute currency
          #
          #   @return [Symbol, DodoPayments::Models::ProductListResponse::PriceDetail::RecurringPrice::Currency]
          required :currency,
                   enum: -> { DodoPayments::Models::ProductListResponse::PriceDetail::RecurringPrice::Currency }
          ...
          #
          #   @return [Symbol, DodoPayments::Models::ProductListResponse::PriceDetail::RecurringPrice::PaymentFrequencyInterval]
          required :payment_frequency_interval,
                   enum: -> { DodoPayments::Models::ProductListResponse::PriceDetail::RecurringPrice::PaymentFrequencyInterval }
          ...
          #
          #   @return [Symbol, DodoPayments::Models::ProductListResponse::PriceDetail::RecurringPrice::SubscriptionPeriodInterval]
          required :subscription_period_interval,
                   enum: -> { DodoPayments::Models::ProductListResponse::PriceDetail::RecurringPrice::SubscriptionPeriodInterval }
          ...
          # @!parse
          #   # @param currency [Symbol, DodoPayments::Models::ProductListResponse::PriceDetail::RecurringPrice::Currency]
          #   # @param discount [Float]
          #   # @param payment_frequency_count [Integer]
          #   # @param payment_frequency_interval [Symbol, DodoPayments::Models::ProductListResponse::PriceDetail::RecurringPrice::PaymentFrequencyInterval]
          #   # @param price [Integer]
          #   # @param purchasing_power_parity [Boolean]
          #   # @param subscription_period_count [Integer]
          #   # @param subscription_period_interval [Symbol, DodoPayments::Models::ProductListResponse::PriceDetail::RecurringPrice::SubscriptionPeriodInterval]
          #   # @param tax_inclusive [Boolean, nil]
        ...
        # @!parse
        #   class << self
        #     # @return [Array(DodoPayments::Models::ProductListResponse::PriceDetail::OneTimePrice, DodoPayments::Models::ProductListResponse::PriceDetail::RecurringPrice)]
        #     def variants; end
        #   end
      end
    end
