...
module DodoPayments
  module Models
    class ProductCreateParams < DodoPayments::BaseModel
      ...
      # @!attribute price
      #
      #   @return [DodoPayments::Models::ProductCreateParams::Price::OneTimePrice, DodoPayments::Models::ProductCreateParams::Price::RecurringPrice]
      required :price, union: -> { DodoPayments::Models::ProductCreateParams::Price }
      ...
      #
      #   @return [DodoPayments::Models::ProductCreateParams::LicenseKeyDuration, nil]
      optional :license_key_duration,
               -> { DodoPayments::Models::ProductCreateParams::LicenseKeyDuration },
               nil?: true
      ...
      #   # @param license_key_duration [DodoPayments::Models::ProductCreateParams::LicenseKeyDuration, nil]
      ...
      class Price < DodoPayments::Union
        ...
        variant :one_time_price, -> { DodoPayments::Models::ProductCreateParams::Price::OneTimePrice }

        variant :recurring_price, -> { DodoPayments::Models::ProductCreateParams::Price::RecurringPrice }

        class OneTimePrice < DodoPayments::BaseModel
          # @!attribute currency
          #
          #   @return [Symbol, DodoPayments::Models::ProductCreateParams::Price::OneTimePrice::Currency]
          required :currency, enum: -> { DodoPayments::Models::ProductCreateParams::Price::OneTimePrice::Currency }
          ...
          # @!parse
          #   # @param currency [Symbol, DodoPayments::Models::ProductCreateParams::Price::OneTimePrice::Currency]
        ...
        class RecurringPrice < DodoPayments::BaseModel
          # @!attribute currency
          #
          #   @return [Symbol, DodoPayments::Models::ProductCreateParams::Price::RecurringPrice::Currency]
          required :currency,
                   enum: -> { DodoPayments::Models::ProductCreateParams::Price::RecurringPrice::Currency }
          ...
          #
          #   @return [Symbol, DodoPayments::Models::ProductCreateParams::Price::RecurringPrice::PaymentFrequencyInterval]
          required :payment_frequency_interval,
                   enum: -> { DodoPayments::Models::ProductCreateParams::Price::RecurringPrice::PaymentFrequencyInterval }
          ...
          #
          #   @return [Symbol, DodoPayments::Models::ProductCreateParams::Price::RecurringPrice::SubscriptionPeriodInterval]
          required :subscription_period_interval,
                   enum: -> { DodoPayments::Models::ProductCreateParams::Price::RecurringPrice::SubscriptionPeriodInterval }
          ...
          # @!parse
          #   # @param currency [Symbol, DodoPayments::Models::ProductCreateParams::Price::RecurringPrice::Currency]
          #   # @param discount [Float]
          #   # @param payment_frequency_count [Integer]
          #   # @param payment_frequency_interval [Symbol, DodoPayments::Models::ProductCreateParams::Price::RecurringPrice::PaymentFrequencyInterval]
          #   # @param price [Integer]
          #   # @param purchasing_power_parity [Boolean]
          #   # @param subscription_period_count [Integer]
          #   # @param subscription_period_interval [Symbol, DodoPayments::Models::ProductCreateParams::Price::RecurringPrice::SubscriptionPeriodInterval]
          #   # @param tax_inclusive [Boolean, nil]
        ...
        # @!parse
        #   class << self
        #     # @return [Array(DodoPayments::Models::ProductCreateParams::Price::OneTimePrice, DodoPayments::Models::ProductCreateParams::Price::RecurringPrice)]
        #     def variants; end
        #   end
      end
      ...
      class LicenseKeyDuration < DodoPayments::BaseModel
        ...
        # @!attribute interval
        #
        #   @return [Symbol, DodoPayments::Models::ProductCreateParams::LicenseKeyDuration::Interval]
        required :interval, enum: -> { DodoPayments::Models::ProductCreateParams::LicenseKeyDuration::Interval }

        # @!parse
        #   # @param count [Integer]
        #   # @param interval [Symbol, DodoPayments::Models::ProductCreateParams::LicenseKeyDuration::Interval]
        #   #
