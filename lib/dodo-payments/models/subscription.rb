...
module DodoPayments
  module Models
    class Subscription < DodoPayments::BaseModel
      ...
      # @!attribute customer
      #
      #   @return [DodoPayments::Models::Subscription::Customer]
      required :customer, -> { DodoPayments::Models::Subscription::Customer }
      ...
      #
      #   @return [Symbol, DodoPayments::Models::Subscription::PaymentFrequencyInterval]
      required :payment_frequency_interval,
               enum: -> { DodoPayments::Models::Subscription::PaymentFrequencyInterval }
      ...
      # @!attribute status
      #
      #   @return [Symbol, DodoPayments::Models::Subscription::Status]
      required :status, enum: -> { DodoPayments::Models::Subscription::Status }
      ...
      #
      #   @return [Symbol, DodoPayments::Models::Subscription::SubscriptionPeriodInterval]
      required :subscription_period_interval,
               enum: -> { DodoPayments::Models::Subscription::SubscriptionPeriodInterval }
      ...
      #   # @param customer [DodoPayments::Models::Subscription::Customer]
      #   # @param metadata [Hash{Symbol=>String}]
      #   # @param next_billing_date [Time]
      #   # @param payment_frequency_count [Integer]
      #   # @param payment_frequency_interval [Symbol, DodoPayments::Models::Subscription::PaymentFrequencyInterval]
      #   # @param product_id [String]
      #   # @param quantity [Integer]
      #   # @param recurring_pre_tax_amount [Integer]
      #   # @param status [Symbol, DodoPayments::Models::Subscription::Status]
