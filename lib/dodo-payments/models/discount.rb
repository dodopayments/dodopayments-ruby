...
module DodoPayments
  module Models
    class Discount < DodoPayments::BaseModel
      ...
      # @!attribute type
      #
      #   @return [Symbol, DodoPayments::Models::Discount::Type]
      required :type, enum: -> { DodoPayments::Models::Discount::Type }
      ...
      #   # @param type [Symbol, DodoPayments::Models::Discount::Type]
