  ...
  module Internal
    module Type
      ...
      module Union
        ...
        # @api private
        #
        # @param key [Symbol, Hash{Symbol=>Object}, Proc, Dodopayments::Internal::Type::Converter, Class]
        #
        ...
        def coerce(value, state:)
          if (target = resolve_variant(value))
            return Dodopayments::Internal::Type::Converter.coerce(target, value, state: state)
          end
