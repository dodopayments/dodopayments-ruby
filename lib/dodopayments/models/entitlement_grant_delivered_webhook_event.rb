...
module Dodopayments
  module Models
    class EntitlementGrantDeliveredWebhookEvent < Dodopayments::Internal::Type::BaseModel
      ...
      # @!attribute data
      #
      #   @return [Dodopayments::Models::EntitlementGrantDeliveredWebhookEvent::Data]
      required :data, -> { Dodopayments::EntitlementGrantDeliveredWebhookEvent::Data }
      ...
      #
      #   @param data [Dodopayments::Models::EntitlementGrantDeliveredWebhookEvent::Data]
      #
      #   @param timestamp [Time] The timestamp of when the event occurred
      #
      #   @param type [Symbol, Dodopayments::Models::EntitlementGrantDeliveredWebhookEvent::Type] The event type

      # @see Dodopayments::Models::EntitlementGrantDeliveredWebhookEvent#data
      class Data < Dodopayments::Internal::Type::BaseModel
        ...
        # @!attribute status
        #
        #   @return [Symbol, Dodopayments::Models::EntitlementGrantDeliveredWebhookEvent::Data::Status]
        required :status, enum: -> { Dodopayments::EntitlementGrantDeliveredWebhookEvent::Data::Status }
        ...
        #
        #   @return [Dodopayments::Models::EntitlementGrantDeliveredWebhookEvent::Data::LicenseKey, nil]
        optional :license_key,
                 -> { Dodopayments::EntitlementGrantDeliveredWebhookEvent::Data::LicenseKey },
                 nil?: true
        ...
        #   {Dodopayments::Models::EntitlementGrantDeliveredWebhookEvent::Data} for more
        #   details.
        #
        #   @param id [String]
        #
        ...
        #
        #   @param status [Symbol, Dodopayments::Models::EntitlementGrantDeliveredWebhookEvent::Data::Status]
        #
        ...
        #
        #   @param license_key [Dodopayments::Models::EntitlementGrantDeliveredWebhookEvent::Data::LicenseKey, nil] Present only when the entitlement integration_type is `license_key`.
        #
        ...
        # @see Dodopayments::Models::EntitlementGrantDeliveredWebhookEvent::Data#status
        module Status
        ...
        # @see Dodopayments::Models::EntitlementGrantDeliveredWebhookEvent::Data#license_key
