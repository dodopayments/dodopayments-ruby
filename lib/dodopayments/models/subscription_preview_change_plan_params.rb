...
module Dodopayments
  module Models
    ...
    class SubscriptionPreviewChangePlanParams < Dodopayments::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Dodopayments::Models::SubscriptionPreviewChangePlanParams::OnPaymentFailure, nil]
      optional :on_payment_failure,
               enum: -> { Dodopayments::SubscriptionPreviewChangePlanParams::OnPaymentFailure },
               nil?: true
