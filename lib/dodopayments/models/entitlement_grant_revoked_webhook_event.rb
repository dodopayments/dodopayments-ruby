...
module Dodopayments
  module Models
    class EntitlementGrantRevokedWebhookEvent < Dodopayments::Internal::Type::BaseModel
      ...
      # @!attribute data
      #
      #   @return [Dodopayments::Models::EntitlementGrantRevokedWebhookEvent::Data]
      required :data, -> { Dodopayments::EntitlementGrantRevokedWebhookEvent::Data }
      ...
      #
      #   @param data [Dodopayments::Models::EntitlementGrantRevokedWebhookEvent::Data]
      #
      #   @param timestamp [Time] The timestamp of when the event occurred
      #
      #   @param type [Symbol, Dodopayments::Models::EntitlementGrantRevokedWebhookEvent::Type] The event type

      # @see Dodopayments::Models::EntitlementGrantRevokedWebhookEvent#data
      class Data < Dodopayments::Internal::Type::BaseModel
        ...
        # @!attribute status
        #
        #   @return [Symbol, Dodopayments::Models::EntitlementGrantRevokedWebhookEvent::Data::Status]
        required :status, enum: -> { Dodopayments::EntitlementGrantRevokedWebhookEvent::Data::Status }
        ...
        #
        #   @return [Dodopayments::Models::EntitlementGrantRevokedWebhookEvent::Data::LicenseKey, nil]
        optional :license_key,
                 -> { Dodopayments::EntitlementGrantRevokedWebhookEvent::Data::LicenseKey },
                 nil?: true
        ...
        #   {Dodopayments::Models::EntitlementGrantRevokedWebhookEvent::Data} for more
        #   details.
        #
        #   @param id [String]
        #
        ...
        #
        #   @param status [Symbol, Dodopayments::Models::EntitlementGrantRevokedWebhookEvent::Data::Status]
        #
        ...
        #
        #   @param license_key [Dodopayments::Models::EntitlementGrantRevokedWebhookEvent::Data::LicenseKey, nil] Present only when the entitlement integration_type is `license_key`.
        #
        ...
        # @see Dodopayments::Models::EntitlementGrantRevokedWebhookEvent::Data#status
        module Status
        ...
        # @see Dodopayments::Models::EntitlementGrantRevokedWebhookEvent::Data#license_key
