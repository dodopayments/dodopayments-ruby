...
module Dodopayments
  module Models
    ...
    class BrandUpdateResponse < Dodopayments::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Dodopayments::Models::BrandUpdateResponse::VerificationStatus]
      required :verification_status, enum: -> { Dodopayments::Models::BrandUpdateResponse::VerificationStatus }
      ...
      #
      #   @param verification_status [Symbol, Dodopayments::Models::BrandUpdateResponse::VerificationStatus]
      #
      ...
      # @see Dodopayments::Models::BrandUpdateResponse#verification_status
