...
module Dodopayments
  module Models
    class EntitlementGrantFailedWebhookEvent < Dodopayments::Internal::Type::BaseModel
      ...
      # @!attribute data
      #
      #   @return [Dodopayments::Models::EntitlementGrantFailedWebhookEvent::Data]
      required :data, -> { Dodopayments::EntitlementGrantFailedWebhookEvent::Data }
      ...
      #
      #   @param data [Dodopayments::Models::EntitlementGrantFailedWebhookEvent::Data]
      #
      #   @param timestamp [Time] The timestamp of when the event occurred
      #
      #   @param type [Symbol, Dodopayments::Models::EntitlementGrantFailedWebhookEvent::Type] The event type

      # @see Dodopayments::Models::EntitlementGrantFailedWebhookEvent#data
      class Data < Dodopayments::Internal::Type::BaseModel
        ...
        # @!attribute status
        #
        #   @return [Symbol, Dodopayments::Models::EntitlementGrantFailedWebhookEvent::Data::Status]
        required :status, enum: -> { Dodopayments::EntitlementGrantFailedWebhookEvent::Data::Status }
        ...
        #
        #   @return [Dodopayments::Models::EntitlementGrantFailedWebhookEvent::Data::LicenseKey, nil]
        optional :license_key,
                 -> { Dodopayments::EntitlementGrantFailedWebhookEvent::Data::LicenseKey },
                 nil?: true
        ...
        #   {Dodopayments::Models::EntitlementGrantFailedWebhookEvent::Data} for more
        #   details.
        #
        #   @param id [String]
        #
        ...
        #
        #   @param status [Symbol, Dodopayments::Models::EntitlementGrantFailedWebhookEvent::Data::Status]
        #
        ...
        #
        #   @param license_key [Dodopayments::Models::EntitlementGrantFailedWebhookEvent::Data::LicenseKey, nil] Present only when the entitlement integration_type is `license_key`.
        #
        ...
        # @see Dodopayments::Models::EntitlementGrantFailedWebhookEvent::Data#status
        module Status
        ...
        # @see Dodopayments::Models::EntitlementGrantFailedWebhookEvent::Data#license_key
