...
module Dodopayments
  module Models
    ...
    class BrandCreateResponse < Dodopayments::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Dodopayments::Models::BrandCreateResponse::VerificationStatus]
      required :verification_status, enum: -> { Dodopayments::Models::BrandCreateResponse::VerificationStatus }
      ...
      #
      #   @param verification_status [Symbol, Dodopayments::Models::BrandCreateResponse::VerificationStatus]
      #
      ...
      # @see Dodopayments::Models::BrandCreateResponse#verification_status
