...
module Dodopayments
  module Transport
    ...
    class BaseClient
        ...
        def follow_redirect(request, status:, response_headers:)
          ...
          location =
            Kernel.then do
              ...
              raise Dodopayments::Errors::APIConnectionError.new(url: url, message: message)
            end
      ...
      # @api private
      # @return [Dodopayments::Transport::PooledNetRequester]
      ...
      def initialize(
        ...
        @requester = Dodopayments::Transport::PooledNetRequester.new
      ...
      #
      #   @option req [Dodopayments::Type::Converter, Class, nil] :model
      #
      ...
      def request(req)
        ...
        in { page: Class => page }
          ...
          Dodopayments::Type::Converter.coerce(model, unwrapped)
        end
      end
