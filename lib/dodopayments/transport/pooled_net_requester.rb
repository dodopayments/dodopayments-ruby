    ...
    class PooledNetRequester
      ...
      class << self
        ...
        def calibrate_socket_timeout(conn, deadline)
          timeout = deadline - Dodopayments::Util.monotonic_secs
        ...
        def build_request(request, &blk)
          ...
          in String
            ...
            req.body_stream = Dodopayments::Util::ReadIOAdapter.new(body, &blk)
          in StringIO
      ...
      private def with_pool(url, deadline:, &blk)
        origin = Dodopayments::Util.uri_origin(url)
        timeout = deadline - Dodopayments::Util.monotonic_secs
        pool =
      ...
      def execute(request)
        ...
        body = Dodopayments::Util.fused_enum(enum, external: true) do
          finished = true
          tap do
            enum.next
