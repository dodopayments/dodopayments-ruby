    ...
    module Converter
      ...
      class << self
        ...
        def type_info(spec)
          ...
          in Dodopayments::Type::Converter | Class | Symbol
            -> { spec }
        ...
        #
        # @param target [Dodopayments::Type::Converter, Class]
        #
        # @param value [Object]
        #
        ...
        def coerce(
          ...
          case target
          in Dodopayments::Type::Converter
        ...
        def dump(target, value)
          target.is_a?(Dodopayments::Type::Converter) ? target.dump(value) : Dodopayments::Unknown.dump(value)
        end
      end
    end
