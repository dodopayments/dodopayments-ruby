...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/dodopayments/helpers/` and `examples/` directory.
...
require_relative "../lib/dodopayments"
...
```ruby
gem "dodopayments", git: "https://www.github.com/dodopayments/dodopayments-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/dodopayments/dodopayments-ruby' '<path-to-repo>'
```

```ruby
gem "dodopayments", path: "<path-to-repo>"
```
