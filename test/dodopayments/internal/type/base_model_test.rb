...
class Dodopayments::Test::PrimitiveModelTest < Minitest::Test
  A = Dodopayments::Internal::Type::ArrayOf[-> { Integer }]
  H = Dodopayments::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Dodopayments::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Dodopayments::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      assert_pattern do
        Dodopayments::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Dodopayments::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [String, Pathname(__FILE__)] => Dodopayments::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Dodopayments::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Dodopayments::Internal::Type::Converter.new_coerce_state
      Dodopayments::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Dodopayments::Internal::Type::Converter.dump(target, input, state: state)
...
class Dodopayments::Test::CollectionModelTest < Minitest::Test
  A1 = Dodopayments::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Dodopayments::Internal::Type::HashOf[Integer]

  A2 = Dodopayments::Internal::Type::ArrayOf[H1]
  H2 = Dodopayments::Internal::Type::HashOf[-> { A1 }]

  A3 = Dodopayments::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Dodopayments::Internal::Type::HashOf[Integer, nil?: true]
...
class Dodopayments::Test::BaseModelTest < Minitest::Test
  class M1 < Dodopayments::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Dodopayments::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Dodopayments::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Dodopayments::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Dodopayments::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Dodopayments::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Dodopayments::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Dodopayments::Errors::ConversionError => e
...
class Dodopayments::Test::UnionTest < Minitest::Test
  class U0
    include Dodopayments::Internal::Type::Union
  ...
  class M2 < Dodopayments::Internal::Type::BaseModel
  ...
  class M4 < Dodopayments::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Dodopayments::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Dodopayments::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Dodopayments::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Dodopayments::Test::MetaInfoTest < Minitest::Test
  A1 = Dodopayments::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Dodopayments::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
