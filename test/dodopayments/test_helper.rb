...
class Dodopayments::Test::SingletonClient < Dodopayments::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: Dodopayments::Test::SingletonClient::TEST_API_BASE_URL, bearer_token: "My Bearer Token")
  end
end
...
class Dodopayments::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @dodo_payments = Dodopayments::Test::SingletonClient.instance
  end
