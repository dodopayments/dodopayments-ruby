  ...
  def test_retrieve
    ...
    assert_pattern do
      response => {
        ...
        is_multi_subscription: Dodopayments::Internal::Type::Boolean,
        is_update_payment_method: Dodopayments::Internal::Type::Boolean,
        metadata: ^(Dodopayments::Internal::Type::HashOf[union: Dodopayments::MetadataItem]),
        payment_id: String,
        payment_provider: Dodopayments::Payment::PaymentProvider,
        refunds: ^(Dodopayments::Internal::Type::ArrayOf[Dodopayments::RefundListItem]),
        retry_attempt: Integer,
        settlement_amount: Integer,
        settlement_currency: Dodopayments::Currency,
        subscription_ids: ^(Dodopayments::Internal::Type::ArrayOf[String]),
        total_amount: Integer,
  ...
  def test_list
    ...
    assert_pattern do
      row => {
        ...
        metadata: ^(Dodopayments::Internal::Type::HashOf[union: Dodopayments::MetadataItem]),
        payment_id: String,
        payment_provider: Dodopayments::Models::PaymentListResponse::PaymentProvider,
        subscription_ids: ^(Dodopayments::Internal::Type::ArrayOf[String]),
        total_amount: Integer,
        card_last_four: String | nil,
        card_network: String | nil,
