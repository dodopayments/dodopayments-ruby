  ...
  def test_retrieve
    ...
    assert_pattern do
      response => {
        ...
        customer: Dodopayments::CustomerLimitedDetails,
        has_payment_method: Dodopayments::Internal::Type::Boolean,
        metadata: ^(Dodopayments::Internal::Type::HashOf[union: Dodopayments::MetadataItem]),
        meter_credit_entitlement_cart: ^(Dodopayments::Internal::Type::ArrayOf[Dodopayments::MeterCreditEntitlementCartResponse]),
        meters: ^(Dodopayments::Internal::Type::ArrayOf[Dodopayments::MeterCartResponseItem]),
  ...
  def test_list
    ...
    assert_pattern do
      row => {
        ...
        currency: Dodopayments::Currency,
        customer: Dodopayments::CustomerLimitedDetails,
        discounts: ^(Dodopayments::Internal::Type::ArrayOf[Dodopayments::Models::SubscriptionListResponse::Discount]),
        has_payment_method: Dodopayments::Internal::Type::Boolean,
        metadata: ^(Dodopayments::Internal::Type::HashOf[union: Dodopayments::MetadataItem]),
        next_billing_date: Time,
        on_demand: Dodopayments::Internal::Type::Boolean,
