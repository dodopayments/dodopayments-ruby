  ...
  def test_retrieve
    ...
    assert_pattern do
      response => {
        ...
        created_at: Time,
        credit_entitlement_cart: ^(Dodopayments::Internal::Type::ArrayOf[Dodopayments::Subscription::CreditEntitlementCart]),
        currency: Dodopayments::Currency,
        customer: Dodopayments::CustomerLimitedDetails,
        metadata: ^(Dodopayments::Internal::Type::HashOf[String]),
        meter_credit_entitlement_cart: ^(Dodopayments::Internal::Type::ArrayOf[Dodopayments::Subscription::MeterCreditEntitlementCart]),
