...
class DodopaymentsTest < Minitest::Test
  ...
  def test_raises_on_unknown_environment
    e = assert_raises(ArgumentError) do
      Dodopayments::Client.new(environment: "wrong")
    end
  ...
  def test_client_redirect_307
    ...
    assert_requested(:any, "http://localhost/redirected", times: Dodopayments::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_303
    ...
    assert_requested(:get, "http://localhost/redirected", times: Dodopayments::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(:any, "https://example.com/redirected", times: Dodopayments::Client::MAX_REDIRECTS) do
      headers = _1.headers.keys.map(&:downcase)
